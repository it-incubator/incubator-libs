...
const Help2Debug = (allProps: IconProps) => {
    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <g clipPath={'url(#prefix__clip0_1936_5496)'} fill={'currentColor'}>
            <path
              d={
          ...
          <defs>
            <clipPath id={'prefix__clip0_1936_5496'}>
