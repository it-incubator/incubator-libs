    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__8df7e4f0-cc1f-11ee-8df6-3bc00402ec38)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__8df7e4f0-cc1f-11ee-8df6-3bc00402ec38'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_1610_5025'} />
            </pattern>
            <image
              height={72}
