    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__1d927da0-c743-11ee-9a89-973d58329563)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__1d927da0-c743-11ee-9a89-973d58329563'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_4624_21400'} />
            </pattern>
            <image
              height={72}
