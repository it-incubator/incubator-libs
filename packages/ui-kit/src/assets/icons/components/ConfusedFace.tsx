    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__03d66f10-e477-11ee-9bd8-61e5520b4a1b)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__03d66f10-e477-11ee-9bd8-61e5520b4a1b'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_4624_21397'} />
            </pattern>
            <image
              height={72}
