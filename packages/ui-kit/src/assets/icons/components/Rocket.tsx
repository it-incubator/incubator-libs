    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__8dfaf230-cc1f-11ee-8df6-3bc00402ec38)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__8dfaf230-cc1f-11ee-8df6-3bc00402ec38'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_2433_969'} />
            </pattern>
            <image
              height={72}
