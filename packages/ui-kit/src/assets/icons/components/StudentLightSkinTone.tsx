  ...
  return (
    <IconWrapper
      icon={
        ...
        >
          <path
            fill="url(#prefix__c2c66fd0-bea5-11ee-bdfe-0d316f90c6b9)"
            d="M0 0h72v72H0z"
          />
          <defs>
            <pattern
              id="prefix__c2c66fd0-bea5-11ee-bdfe-0d316f90c6b9"
              patternContentUnits="objectBoundingBox"
              width={1}
              height={1}
            >
              <use
                xlinkHref="#prefix__image0_126_30310"
