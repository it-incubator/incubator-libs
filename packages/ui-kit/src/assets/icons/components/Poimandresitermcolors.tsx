...
const Poimandresitermcolors = (allProps: IconProps) => {
        ...
        <plist version={1}>
          <dict>
            ...
            <dict>
              ...
              <real>{'1'}</real>
              <key>{'Blue Component'}</key>
              <real>{'0.4497559666633606'}</real>
              <key>{'Color Space'}</key>
              <string>{'sRGB'}</string>
              <key>{'Green Component'}</key>
              <real>{'0.70702856779098511'}</real>
              <key>{'Red Component'}</key>
              <real>{'1'}</real>
            </dict>
...
export default Poimandresitermcolors
