...
const Fire1 = (allProps: IconProps) => {
    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__9bdc3430-c5e0-11ee-aa1e-dff389dcf943)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__9bdc3430-c5e0-11ee-aa1e-dff389dcf943'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_4624_20503'} />
            </pattern>
            <image
              height={72}
