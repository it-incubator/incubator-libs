    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <path d={'M0 0h72v72H0z'} fill={'url(#prefix__9bd15ec0-c5e0-11ee-aa1e-dff389dcf943)'} />
          <defs>
            <pattern
              height={1}
              id={'prefix__9bd15ec0-c5e0-11ee-aa1e-dff389dcf943'}
              patternContentUnits={'objectBoundingBox'}
              width={1}
            >
              <use transform={'scale(.01389)'} xlinkHref={'#prefix__image0_3027_308'} />
            </pattern>
            <image
              height={72}
